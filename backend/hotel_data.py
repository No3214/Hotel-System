...
ROOMS = [
    {
        "room_id": "quadruple",
        "name_tr": "4 Kisilik Oda",
        "name_en": "Quadruple Room",
        "description_tr": "Aileler ve arkadas gruplari icin ideal, genis alan ve konforlu konaklama.",
        "description_en": "Ideal for families and groups of friends, spacious and comfortable accommodation.",
        "capacity": 4,
        "min_capacity": 2,
        "size_m2": 45,
        "features": ["klima", "LCD TV", "mini buzdolabi", "sac kurutma", "ozel banyo", "WiFi", "balkon"],
        "base_price_try": 5000,
        "base_price_eur": 150,
        "count": 4,
        "view": "mixed",
    ...
    },
    {
        ...
        "description_tr": "Konfor ve lukusun birlestigi, genis ve ferah premium 2 kisilik oda.",
        "description_en": "Premium 2-person room where comfort and luxury meet, spacious and airy.",
        "capacity": 2,
        "min_capacity": 1,
        "size_m2": 50,
    ...
    {
        "room_id": "triple",
        "name_tr": "3 Kisilik Oda",
        "name_en": "Triple Room",
        "description_tr": "Romantik kacamak, arkadas grubu veya kucuk aileler icin tasarlandi.",
        "description_en": "Designed for romantic getaways, groups of friends or small families.",
        "capacity": 3,
        "min_capacity": 2,
        "size_m2": 35,
        "features": ["klima", "LCD TV", "mini buzdolabi", "sac kurutma", "ozel banyo", "WiFi", "balkon"],
    ...
    {
        "room_id": "standard_sea",
        "name_tr": "Standart Oda (Manzarali)",
        "name_en": "Standard Room (Sea View)",
        "description_tr": "Deniz manzarali, otantik tas duvarli konforlu 2 kisilik oda.",
        "description_en": "Sea view, authentic stone-walled comfortable 2-person room.",
        "capacity": 2,
        "min_capacity": 2,
        "size_m2": 25,
        "features": ["klima", "LCD TV", "mini buzdolabi", "sac kurutma", "ozel banyo", "WiFi", "deniz manzarasi"],
        "base_price_try": 3500,
        "base_price_eur": 105,
        "count": 4,
        "view": "sea",
    ...
    {
        "room_id": "standard_land",
        "name_tr": "Standart Oda (Kara Manzarali)",
        "name_en": "Standard Room (Land View)",
        "description_tr": "Huzurlu koy ve bahce manzarali oda. Tek kisi icin de uygundur.",
        "description_en": "Peaceful village and garden view room. Also suitable for single guests.",
        "capacity": 2,
        "min_capacity": 1,  # Tek kisi de alabilir
        "size_m2": 25,
        "features": ["klima", "LCD TV", "mini buzdolabi", "sac kurutma", "ozel banyo", "WiFi", "koy manzarasi"],
        "base_price_try": 3000,
        "base_price_eur": 90,
        "single_price_try": 2500,  # Tek kisi fiyati
        "single_price_eur": 75,
        "count": 4,
        "view": "land",
        "accepts_single": True,
